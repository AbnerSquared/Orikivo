...
namespace Orikivo
{
    ...
    public class HuskActions : OriModuleBase<OriCommandContext>
    {
        ...
        public async Task GoToAsync()
        {
            ...
            await Context.Channel.SendMessageAsync(Engine.ShowLocations(Context.Account.Husk));
        }
        ...
        {
            if (Engine.CanChat(Context.Account.Husk, id, out Npc npc))
            {
        ...
        {
            if (Engine.CanShop(Context.Account.Husk, out Market market))
            {
        ...
        public async Task GoToAsync(string id)
        {
            ...
            {
                TravelResult result = Engine.TryGoTo(Context.Account.Husk, id, out Area attempted);
            ...
            {
                TravelResult result = Engine.TryGoTo(Context.Account.Husk, id, out Construct attempted);
