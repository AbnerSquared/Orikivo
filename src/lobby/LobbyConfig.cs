namespace Orikivo
{
    ...
    {
        public LobbyConfig(string name = null, GameMode mode = GameMode.Werewolf, GamePrivacy privacy = GamePrivacy.Public, ReceiverConfig receiverConfig = null)
        {
        ...
        public GamePrivacy Privacy { get; set; } // if the lobby can be seen by other servers.
