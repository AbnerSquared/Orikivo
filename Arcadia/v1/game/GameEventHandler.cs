...
namespace Arcadia.Old
{
    ...
    public class GameEventHandler
    {
        ...
        private readonly AsyncEvent<Func<Identity, GameLobby, Task>> _userJoinedEvent = new AsyncEvent<Func<Identity, GameLobby, Task>>();
        private readonly AsyncEvent<Func<Identity, GameLobby, Task>> _userLeftEvent = new AsyncEvent<Func<Identity, GameLobby, Task>>();
        ...
        public event Func<Identity, GameLobby, Task> UserJoined
        {
        ...
        public event Func<Identity, GameLobby, Task> UserLeft
        {
        ...
        internal async Task InvokeUserJoinedAsync(Identity user, GameLobby lobby)
            => await _userJoinedEvent.InvokeAsync(user, lobby);
        internal async Task InvokeUserLeftAsync(Identity user, GameLobby lobby)
