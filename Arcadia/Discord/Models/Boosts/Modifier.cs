...
namespace Arcadia
{
    ...
    public class Modifier
    {
        ...
        // The amount of times this modifier is used before it is removed. If both use count and duration are unspecified, the value is permanently applied to the base value.
