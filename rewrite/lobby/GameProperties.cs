...
namespace Orikivo
{
    ...
    public class GameProperties
    {
        ...
        public static GameProperties FromMode(GameMode mode)
        {
            ...
            GameTimer task3Timer = new GameTimer(TimeSpan.FromSeconds(10), new GameRoute(TaskRoute.Timeout, "task:timeout"));


            GameTask Task1 = new GameTask(task1, new List<GameAttribute> { timesCalled },
                new List<GameTrigger> { crit1Call }, new List<TaskCriterion> { crit1 }, onCancel);
