...
namespace Orikivo
{
    ...
    public class OriColor
    {
        ...
        /*
        public static implicit operator DiscordColor(Drawing.GammaColor c)
            => new DiscordColor((uint)c.Value << 8 >> 8);
        public static explicit operator Drawing.GammaColor(DiscordColor c)
            => new Drawing.GammaColor(c.RawValue);
        */
