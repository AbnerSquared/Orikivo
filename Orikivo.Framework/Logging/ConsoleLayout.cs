...
namespace Orikivo
{
    ...
    {
        /// <summary>
        /// Returns the default <see cref="ConsoleLayout"/>.
        /// </summary>
        public static ConsoleLayout Default
        {
            get
            {
        ...
        /// <summary>
        /// Returns the current <see cref="ConsoleLayout"/> that is applied to the <see cref="Console"/>.
        /// </summary>
        public static ConsoleLayout Current
        {
            get
            {
                ConsoleLayout config = new ConsoleLayout();
                config.Synchronize();
                return config;
            }
        }
        ...
        /// <summary>
        /// Updates the <see cref="ConsoleLayout"/> to represent the current <see cref="Console"/> configuration.
        /// </summary>
        ...
        /// <summary>
        /// Applies the <see cref="ConsoleLayout"/> to the <see cref="Console"/>.
        /// </summary>
        public void Apply()
        {
